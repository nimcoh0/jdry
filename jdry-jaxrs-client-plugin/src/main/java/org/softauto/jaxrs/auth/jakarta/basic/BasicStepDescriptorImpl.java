...
public class BasicStepDescriptorImpl extends AbstractStepDescriptorImpl {
    ...
    public Entity<?> getEntity() {
        ...
        try {
            ...
            entity = (Entity<?>) org.softauto.jaxrs.auth.jakarta.EntityBuilder.newBuilder().setCallOptions(callOptions).setProduce(consume).setArgs(args).setArgsNames(argumentsNames).build().getEntity();
