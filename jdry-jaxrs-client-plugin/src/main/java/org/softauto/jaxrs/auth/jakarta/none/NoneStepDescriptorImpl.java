package org.softauto.jaxrs.auth.jakarta.none;
...
public class NoneStepDescriptorImpl extends AbstractStepDescriptorImpl {
    ...
    public Entity<?> getEntity() {
        ...
        return (Entity<?>) org.softauto.jaxrs.auth.jakarta.EntityBuilder.newBuilder().setCallOptions(callOptions).setProduce(consume).setArgs(args).setArgsNames(argumentsNames).build().getEntity();
    }
}
