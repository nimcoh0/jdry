...
public class SpringPluginImpl implements Provider {
    ...
    @Override
    public <RespT> void exec(String name, org.apache.avro.ipc.CallFuture<RespT> callback, ManagedChannel channel, Object[] args, Class[] types, HashMap<String, Object> callOptions) {
