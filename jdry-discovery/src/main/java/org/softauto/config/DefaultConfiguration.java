...
public class DefaultConfiguration {
    ...
    static{
        ...
        configuration.put(Context.FILE_PATH,"target/generated-sources/");
        ...
        configuration.put(Context.DISCOVER_BY_ANNOTATION,new Object[]{"ApiForTesting","StepForTesting", "VerifyForTesting", "ListenerForTesting"});
