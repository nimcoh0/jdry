...
public class HandleReturnType1 {
    ...
    public HandleReturnType1 setUnboxExcludeList(List<String> unboxExcludeList) {
        this.unboxExcludeList = unboxExcludeList;
        return this;
    }

    public HandleReturnType1 setUnboxList(List<String> unboxList) {
        this.unboxList = unboxList;
        return this;
    }

    public HandleReturnType1 setBody(Body body) {
        this.body = body;
        return this;
    }


    public HandleReturnType1 setResponseObject(String responseObject) {
