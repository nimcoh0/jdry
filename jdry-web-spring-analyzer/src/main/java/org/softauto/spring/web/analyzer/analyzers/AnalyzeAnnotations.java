                ...
                for (Map.Entry entry : classList.entrySet()) {
                    ...
                    if (start && ((Map) entry.getValue()).size() > 0) {
                        ...
                        for (Map.Entry k : l.entrySet()) {
                            if (k.getKey().toString().contains("org.springframework.web.bind.annotation.RequestMapping")) {
                        ...
                        if (tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.RequestMapping")) {
                            if(((Map) tree.getAnnotations().get("org.springframework.web.bind.annotation.RequestMapping")).containsKey("produces")) {
                                produce = ((Map) tree.getAnnotations().get("org.springframework.web.bind.annotation.RequestMapping")).get("produces").toString();
                            }
            ...
            //for(LinkedHashMap<String, Object> hm : classList){
                ...
                for (Map.Entry entry : classList.entrySet()) {
                    ...
                    if (start && ((Map) entry.getValue()).size() > 0) {
                        ...
                        if (tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.RequestMapping")) {
                            if(((Map) tree.getAnnotations().get("org.springframework.web.bind.annotation.RequestMapping")).containsKey("consumes")) {
                                consume = ((Map) tree.getAnnotations().get("org.springframework.web.bind.annotation.RequestMapping")).get("consumes").toString();
                            }
        ...
        try {
           ...
           // for(LinkedHashMap<String, Object> hm : classList){
              if (isEndPoint() && classList.keySet().contains(tree.getNamespce())) {
                  ...
                  String _path = null;
                  if (tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.RequestMapping")) {
                      if(((Map) tree.getAnnotations().get("org.springframework.web.bind.annotation.RequestMapping")).containsKey("value"))
                      _path =  ((Map) tree.getAnnotations().get("org.springframework.web.bind.annotation.RequestMapping")).get("value").toString();
                  }
                  if(tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.PostMapping")){
                      if(((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.PostMapping")).containsKey("value"))
                      _path =  ((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.PostMapping")).get("value").toString();
                  }
                  if(tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.GetMapping")){
                      if(((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.GetMapping")).containsKey("value"))
                      _path =  ((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.GetMapping")).get("value").toString();
                  }
                  if(tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.DeleteMapping")){
                      if(((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.DeleteMapping")).containsKey("value"))
                      _path =  ((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.DeleteMapping")).get("value").toString();
                  }
                  if(tree.getAnnotations().containsKey("org.springframework.web.bind.annotation.PutMapping")){
                      if(((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.PutMapping")).containsKey("value"))
                      _path =  ((Map)tree.getAnnotations().get("org.springframework.web.bind.annotation.PutMapping")).get("value").toString();
                  }
                  if(_path != null){
                      if(_path.startsWith("/")){
