...
public class HandleRequestType {
    ...
    private void handleRequestBody(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.RequestBody").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
    ...
    private void handleRequestMapping(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.RequestMapping").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            if(scanner != null && scanner.getMapList().size() > 0) {
    ...
    private void handlePostMapping(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.PostMapping;").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            if(scanner != null && scanner.getMapList().size() > 0) {
                for (Map<String, Object> map : scanner.getMapList()) {
                    if(map.containsKey("value")){
    ...
    private void handleGetMapping(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.GetMapping").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            if(scanner != null && scanner.getMapList().size() > 0) {
                for (Map<String, Object> map : scanner.getMapList()) {
                    if(map.containsKey("value")){
    ...
    private void handleDeleteMapping(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.DeleteMapping").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            if(scanner != null && scanner.getMapList().size() > 0) {
                for (Map<String, Object> map : scanner.getMapList()) {
                    if(map.containsKey("value")){
    ...
    private void handlePutMapping(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.PutMapping").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            if(scanner != null && scanner.getMapList().size() > 0) {
                for (Map<String, Object> map : scanner.getMapList()) {
                    if(map.containsKey("value")){
    ...
    private void handleRequestParam(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.RequestParam").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            LinkedList<LinkedHashMap<String, Object>> args = buildArgList(scanner);
    ...
    private void handlePathVariable(){
        AbstractAnnotationScanner scanner = new AnnotationScanner().setPath("org.springframework.web.bind.annotation.PathVariable").setAnnotations(tree.getAnnotations()).scanner();
        if(scanner != null ){
            LinkedList<LinkedHashMap<String, Object>> args = buildArgList(scanner);
