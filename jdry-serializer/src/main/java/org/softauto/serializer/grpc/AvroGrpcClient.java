...
package org.softauto.serializer.grpc;
  ...
  private static class ServiceInvocationHandler implements InvocationHandler {
    ...
    private static class CallbackToResponseStreamObserverAdpater<T> implements StreamObserver<Object> {
      ...
      public void onNext(Object value) {
        try {
          if(value != null) {
            String newContent = new String(((ByteBuffer) value).array(), StandardCharsets.UTF_8);
            value =  new ObjectMapper().readValue(newContent,Object.class);
          }
